...
# The destination for the Flyway report
# Defaults to the current directory and base filename of 'report':
# flyway.reportFilename

# Your Flyway license key (FL01...). Not yet a Flyway Teams/Enterprise Edition customer?
# To try out the extended features in Flyway for 30 days, request your Flyway trial license key at:
# Teams - https://www.red-gate.com/products/flyway/teams/trial/
# Enterprise - https://www.red-gate.com/products/flyway/enterprise/trial/
# Flyway Teams/Enterprise only
# flyway.licenseKey=
```
