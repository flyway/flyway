...
To set this up, you will need to pass the path to your Kerberos configuration file to the parameter [`kerberosConfigFile`](Configuration/Parameters/Kerberos Config File) and the path to your login module configuration file to the parameter [`plugin.sqlserver.kerberos.login.file`](Configuration/Parameters/SQL Server Kerberos Login File).
...
either on a [per-script basis](Configuration/Script Config Files) or globally.
