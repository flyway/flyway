...
For each database Flyway works with, we publish a documentation page, like this one for [PostgreSQL](Supported Databases/postgresql). On these pages you'll see a list of "Supported Versions", along with "Support Level". For PostgreSQL, the Support Levels look like this:
...
**Ready to add compatibility for your database?** [Learn how to add compatibility for your database to Flyway](Contribute/Contributing Database Compatibility to Flyway)
...
**Ready to get your database certified?** [Learn how to get your database certified with Flyway](Learn More/Getting Flyway Certified support for your database)
