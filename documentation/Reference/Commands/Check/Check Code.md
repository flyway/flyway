...
| [`code.profile`](<Configuration/Flyway Namespace/Flyway Check Namespace/Flyway Check Code Profile Setting>) | check     | The profile to run code review with. Defaults to none, every enabled rule.                                       |
| [`code.profiles`](<Configuration/Flyway Namespace/Flyway Check Namespace/Flyway Check Code Profiles Setting>) | check     | The rules and rule groups each code review profile excludes.                                                     |
