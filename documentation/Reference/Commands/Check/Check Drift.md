...
| [`driftResolutionFolder`](<Configuration/Flyway Namespace/Flyway Check Namespace/Flyway Check Drift Resolution Folder Setting>)                    | check     | The folder in which drift resolution scripts are generated, if drift is detected.                                     |
