...
[schema history table](https://documentation.red-gate.com/flyway/flyway-concepts/migrations/flyway-schema-history-table), ensuring that all schema changes are tracked the usual way.  
