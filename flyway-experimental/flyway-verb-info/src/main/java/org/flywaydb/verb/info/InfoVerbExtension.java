...
public class InfoVerbExtension implements VerbExtension {
    ...
    public Object executeVerb(final Configuration configuration) {
        ...
        try {
            ...
            final MigrationInfo[] migrations = getMigrations(schemaHistoryModel, resources.toArray(LoadableResourceMetadata[]::new), configuration);

            return new ExperimentalMigrationInfoService(migrations, configuration, experimentalDatabase.getName(), experimentalDatabase.allSchemasEmpty());
    ...
    @Value
    private class MigrationKey implements Comparable<MigrationKey> {
    ...
    private MigrationInfo[] getMigrations(final SchemaHistoryModel schemaHistoryModel, final LoadableResourceMetadata[] sortedMigrations, final Configuration configuration) {
        ...
        final var comparator = getOrderComparator(configuration);
    ...
    private List<LoadableResourceMetadata> getResolvedMigrations(final LoadableResourceMetadata[] sortedMigrations,
    ...
    private void insertResolvedSchemaHistoryItems(final List<ResolvedSchemaHistoryItem> resolvedSchemaHistoryItems,
    ...
    private void insertResolvedMigrations(final Iterable<LoadableResourceMetadata> resolvedMigrations,
    ...
    private void insertUndoneMigrations(final Collection<ResolvedSchemaHistoryItem> resolvedSchemaHistoryItems,
    ...
    private void insertPendingRepeatables(final Collection<ResolvedSchemaHistoryItem> resolvedSchemaHistoryItems,
        final Collection<LoadableResourceMetadata> resolvedMigrations,
        final Map<? super MigrationKey, ? super Pair<ResolvedSchemaHistoryItem, LoadableResourceMetadata>> migrations) {
    ...
    private LoadableResourceMetadata getTypedMigration(final Configuration configuration,
    ...
    private MigrationType getMigrationType(final LoadableResource resource, final Configuration configuration) {
