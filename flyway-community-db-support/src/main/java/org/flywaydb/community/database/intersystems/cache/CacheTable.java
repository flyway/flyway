 ...
 * @author Oliver Stahl
 */
public class CacheTable extends Table<CacheDatabase, CacheSchema>
{
   /**
    ...
    */
   CacheTable(JdbcTemplate jdbcTemplate, CacheDatabase database, CacheSchema schema, String name)
   {
