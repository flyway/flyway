...
ALTER TABLE "${schema}"."${table}" MODIFY ("execution_time" NUMBER(38,0) NOT NULL);

ALTER TABLE "${schema}"."${table}" ADD "version_rank" NUMBER(38,0);
ALTER TABLE "${schema}"."${table}" ADD "installed_rank" NUMBER(38,0);
