...
public class Flyway {
	...
	/**
	 * @param basePackage
	 *            The base package where the migrations are located. (default:
	 *            db.migration)
	 */
	...
	/**
	 * @param baseDir
	 *            The base directory on the classpath where the Sql migrations
	 ...
	 *            The name of the schema metadata table that will be used by
	...
	/**
	 * @param placeholders
	 *            A map of <placeholder, replacementValue> to apply to sql
	 *            migration scripts.
	 */
	...
	/**
	 * @param dataSource
	 *            The datasource to use. Must have the necessary privileges to
	 *            execute ddl.
	 */
