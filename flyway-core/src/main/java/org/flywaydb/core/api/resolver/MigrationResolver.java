 ...
 * used to create additional types of migrations not covered by the standard resolvers (jdbc, sql). Using the
...
public interface MigrationResolver extends Plugin {
     ...
     */
    default String getPrefix(final Configuration configuration) {
        return null;
    }
