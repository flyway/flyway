...
public interface MigrationExecutor {
    ...
    /**
     * Optionally, an executor may provide an expression string describing the conditions under which
     * {@code shouldExecute} may return {@code true}. The {@code shouldExecute} function itself is the source of truth
     * for whether a script may execute, this function is provided for providing additional information rather than
     * direct evaluation.
     *
