...
public class DiffTextCommandExtensionStub implements CommandExtension<OperationResult> {
    private static final String FEATURE_NAME = "DiffText";
    public static final String COMMAND = "diffText";
    public static final String DESCRIPTION = "Prints out the object level differences from the differences generated by the diff command";
