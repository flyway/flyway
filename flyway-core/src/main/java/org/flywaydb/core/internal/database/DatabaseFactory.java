...
import org.flywaydb.core.internal.database.exasol.ExasolDatabase;
import org.flywaydb.core.internal.database.exasol.ExasolParser;
...
public class DatabaseFactory {
    ...
    private static Database createDatabase(DatabaseType databaseType, Configuration configuration,
        ...
        switch (databaseType) {
            ...
            case EXASOL:
                return new ExasolDatabase(configuration, jdbcConnectionFactory);
            default:
