...
public class DbBaseline {
    ...
    /**
     * This is a list of callbacks that fire before or after the baseline task
     * is executed. You can add as many callbacks as you want. These should be
     * set on the Flyway class by the end user as Flyway will set them
     * automatically for you here.
     */
     ...
     *
     * @param connection The database connection to use for accessing the
     * metadata table.
     * @param dbSupport The DB support for the connection.
     * @param metaDataTable The database metadata table.
     * @param schema The database schema to use by default.
     * @param baselineVersion The version to tag an existing schema with when
     * executing baseline.
     * @param baselineDescription The description to tag an existing schema with
     * when executing baseline.
     */
