 ...
 */
class SAPHANASqlScript extends SqlScript {
    SAPHANASqlScript(String sqlScriptSource) {
        super(sqlScriptSource);
    }

    SAPHANASqlScript(LoadableResource sqlScriptResource, PlaceholderReplacer placeholderReplacer,
