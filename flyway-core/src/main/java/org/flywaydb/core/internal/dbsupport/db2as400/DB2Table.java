...
public class DB2Table extends Table {
    ...
    protected boolean doExists() throws SQLException {
        final String tableName = jdbcTemplate.queryForString("select TABLE_NAME from QSYS2.SYSTABLES where TABLE_TYPE = 'T' and TABLE_NAME = ? and TABLE_SCHEMA = ?", name, schema.getName());
