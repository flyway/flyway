 ...
 */
class RedshiftSqlScript extends SqlScript<ContextImpl> {
    RedshiftSqlScript(String sqlScriptSource) {
        super(sqlScriptSource);
    }

    RedshiftSqlScript(LoadableResource sqlScriptResource, PlaceholderReplacer placeholderReplacer,
