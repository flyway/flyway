 ...
 */
class InformixSqlScript extends ExecutableSqlScript<ContextImpl> {
    InformixSqlScript(LoadableResource resource, PlaceholderReplacer placeholderReplacer, boolean mixed
    ...
    protected SqlStatementBuilder createSqlStatementBuilder() {
        return new InformixSqlStatementBuilder(Delimiter.SEMICOLON);
    }
}