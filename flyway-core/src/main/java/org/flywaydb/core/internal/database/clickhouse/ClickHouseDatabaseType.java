...
public class ClickHouseDatabaseType extends DatabaseType {
    ...
    @Override
    public Database<ClickHouseConnection> createDatabase(Configuration configuration,
    ...
    public boolean detectPasswordRequiredByUrl(String url) {
        // ClickHouse supports password in URL
