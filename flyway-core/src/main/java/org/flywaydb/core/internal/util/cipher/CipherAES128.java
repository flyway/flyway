 ...
 * Cipher for AES128.
 */
public class CipherAES128 implements CipherAlgo {
    ...
    public String encrypt(String plaintext, String password) {
        try {
            ...
            throw new FlywayException("Unable to encrypt data with AES128", e);
        }
    }
    ...
    public String decrypt(String encryptedText, String password) {
        try {
            ...
            throw new FlywayException("Vault password is incorrect or unable to decrypt data with AES128", e);
        }
    }
}