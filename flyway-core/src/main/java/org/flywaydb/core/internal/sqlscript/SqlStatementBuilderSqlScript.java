...
public class SqlStatementBuilderSqlScript implements SqlScript {
    private static final Log LOG = LogFactory.getLog(SqlStatementBuilderSqlScript.class);
     ...
     */
    public SqlStatementBuilderSqlScript(SqlStatementBuilderFactory sqlStatementBuilderFactory, LoadableResource resource, boolean mixed) {
    ...
    @Override
    public Iterator<SqlStatement> getSqlStatements() {
