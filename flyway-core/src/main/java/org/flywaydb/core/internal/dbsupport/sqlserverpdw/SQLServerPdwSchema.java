...
import org.flywaydb.core.internal.dbsupport.sqlserver.*;
 ...
 */
public class SQLServerPdwSchema extends Schema<SQLServerPdwDbSupport> {
    /**
     ...
     */
    public SQLServerPdwSchema(JdbcTemplate jdbcTemplate, SQLServerPdwDbSupport dbSupport, String name) {
