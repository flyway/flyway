...
@Getter
@Setter
public class DeployScriptConfigurationExtension implements ConfigurationExtension {
    ...
    private String deployScript = SCRIPT_FILENAME_DEFAULT;
    ...
    public static List<ConfigurationParameter> getConfigurationParameters() {
        return List.of(new ConfigurationParameter("deployScript",
            "A deployment script to run against an environment. Can be a script generated by `flyway prepare`. If not specified the location will default to "
