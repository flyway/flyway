 ...
 */
class SybaseASESqlScript extends SqlScript {
    SybaseASESqlScript(String sqlScriptSource) {
        super(sqlScriptSource);
    }

    SybaseASESqlScript(LoadableResource sqlScriptResource, PlaceholderReplacer placeholderReplacer,
