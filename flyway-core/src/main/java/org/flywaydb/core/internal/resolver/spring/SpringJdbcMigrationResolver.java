 ...
 */
public class SpringJdbcMigrationResolver extends AbstractJdbcResolver<SpringJdbcMigration> {

    @Override
    protected Class<SpringJdbcMigration> getTargetInterface() {
        return SpringJdbcMigration.class;
    }

    @Override
    protected MigrationExecutor createExecutor(SpringJdbcMigration migration) {
