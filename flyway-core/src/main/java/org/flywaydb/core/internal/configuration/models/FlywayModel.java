...
public class FlywayModel {
    ...
    public FlywayModel defaults(){
         ...
         sqlMigrationSuffixes = Arrays.asList(".sql");
         oracleSqlplus = false;
         oracleSqlplusWarn = false;
         cleanDisabled = true;
         cleanOnValidationError = false;
         locations = Arrays.asList("db/migration");
         target = "latest";
         table = "flyway_schema_history";
         failOnMissingTarget = false;
         cherryPick = new ArrayList<>();
         placeholderReplacement = true;
         ignoreMigrationPatterns = Arrays.asList("*:future");
         ...
         migrationResolvers = new ArrayList<>();
         skipDefaultResolvers = false;
         mixed = false;
         group = false;
         createSchemas = true;
         errorOverrides = new ArrayList<>();
         stream = false;
         batch = false;
