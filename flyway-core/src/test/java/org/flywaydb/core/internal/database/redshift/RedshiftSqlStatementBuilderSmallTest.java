 ...
 */
public class RedshiftSqlStatementBuilderSmallTest {
    /**
     * Class under test.
     */
    ...
    public void dollarQuoteRegex() {
        assertFalse("abc".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertFalse("abc$".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertFalse("$abc".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertTrue("$$".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertTrue("$abc$".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertTrue("$ABC$".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertTrue("$aBcDeF$".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertTrue("$aBc_DeF$".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertTrue("$abcDEF123$".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
        assertTrue("$abcDEF123$xxx".matches(RedshiftSqlStatementBuilder.DOLLAR_QUOTE_REGEX));
    }
}