...
/**
 * Test for MemSQLSqlStatementBuilder.
 */
public class MemSQLSqlStatementBuilderSmallTest {
    private MemSQLSqlStatementBuilder builder = new MemSQLSqlStatementBuilder();
