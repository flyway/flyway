...
public abstract class MySQLMigrationTestCase extends MigrationTestCase {
    ...
    protected String getQuoteLocation() {
        return "migration/database/mysql/sql/quote";
    }
    ...
    public void storedProcedure() throws Exception {
        flyway.setLocations("migration/database/mysql/sql/procedure");
        flyway.migrate();
    ...
    public void delimiter() throws Exception {
        flyway.setLocations("migration/database/mysql/sql/delimiter");
        flyway.migrate();
    }

    @Test
    public void hashComment() throws Exception {
        flyway.setLocations("migration/database/mysql/sql/hashcomment");
        flyway.migrate();
    }
    ...
    public void trigger() throws Exception {
        flyway.setLocations("migration/database/mysql/sql/trigger");
        flyway.migrate();
    ...
    public void view() throws Exception {
        flyway.setLocations("migration/database/mysql/sql/view");
        flyway.migrate();
    ...
    public void event() throws Exception {
        flyway.setLocations("migration/database/mysql/sql/event");
        flyway.migrate();
        flyway.clean();
    ...
    public void dump() throws Exception {
        flyway.setLocations("migration/database/mysql/sql/dump");
        flyway.migrate();
    ...
    public void upperCase() throws Exception {
        flyway.setLocations("migration/database/mysql/sql/uppercase");
        flyway.migrate();
    ...
    public void doubleQuote() throws FlywayException {
        flyway.setLocations("migration/database/mysql/sql/doublequote");
        flyway.migrate();
    }
    ...
    public void escapeSingleQuote() throws FlywayException {
        flyway.setLocations("migration/database/mysql/sql/escape");
        flyway.migrate();
    }
