...
import org.flywaydb.core.internal.resolver.mongodb.dummy.V2__MongoInterfaceBasedMigration;
import org.flywaydb.core.internal.resolver.mongodb.dummy.Version4dot5;
...
public class MongoMigrationResolverSmallTest {
	...
	public void resolveMigrations() {
	  MongoMigrationResolver migrationResolver =
			new MongoMigrationResolver(scanner, new Location("org/flywaydb/core/internal/resolver/mongodb/dummy"), config);
	...
	public void conventionOverConfiguration() {
	  MongoMigrationResolver mongoMigrationResolver = new MongoMigrationResolver(scanner, null, null);
		ResolvedMigration migrationInfo = mongoMigrationResolver.extractMigrationInfo(new V2__MongoInterfaceBasedMigration());
	...
	public void explicitInfo() {
		MongoMigrationResolver mongoMigrationResolver = new MongoMigrationResolver(scanner, null, null);
		ResolvedMigration migrationInfo = mongoMigrationResolver.extractMigrationInfo(new Version4dot5());
