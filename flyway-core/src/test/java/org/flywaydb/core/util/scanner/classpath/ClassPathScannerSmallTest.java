...
import org.flywaydb.core.dbsupport.db2.DB2MigrationMediumTest;
import org.flywaydb.core.migration.MigrationTestCase;
import org.flywaydb.core.resolver.jdbc.dummy.V2__InterfaceBasedMigration;
import org.flywaydb.core.resolver.jdbc.dummy.V4__DummyExtendedAbstractJdbcMigration;
import org.flywaydb.core.resolver.jdbc.dummy.Version3dot5;
import org.flywaydb.core.util.Resource;
import org.flywaydb.core.util.scanner.classpath.jboss.JBossVFSv2UrlResolver;
...
public class ClassPathScannerSmallTest {
    ...
    public void scanForResourcesSplitDirectory() throws Exception {
        ...
        assertEquals("org/flywaydb/core/dbsupport/db2/createMetaDataTable.sql", resources[0].getLocation());
    }
