...
CREATE TABLE account (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY account_key (account_key,id),
...
CREATE TABLE attachment (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY attachment_key (attachment_key,id)
...
CREATE TABLE custom_template (
  ...
  fk_account bigint(20) NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY fk_account (fk_account,name,language,id)
...
CREATE TABLE customisable_message (
  ...
  fk_account bigint(20) NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY fk_account (fk_account,msg_key,msg_locale,id)
...
CREATE TABLE document (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY repos_id (repos_id,id),
...
CREATE TABLE document_set (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY fk_task (fk_task,document_set_id,id),
...
CREATE TABLE email_template (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY email_templ_key (email_templ_key,id)
)  AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE language (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY display_name (display_name,id),
  UNIQUE KEY iso_code (iso_code,id),
  UNIQUE KEY display_name_2 (display_name,iso_code,id)
)  AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE print_job_files (
  print_job_id bigint(20) NOT NULL PRIMARY KEY,
...
CREATE TABLE print_job_unit (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY fk_print_job (fk_print_job,fk_document_set,id)
)  DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE sender (
  ...
  fk_person bigint(20) DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY fk_account (fk_account,sender_key,id),
...
CREATE TABLE task (
  ...
  fk_account bigint(20) NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY fk_account (fk_account,task_id,id),
...
CREATE TABLE user (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY email_address (email_address,id)
