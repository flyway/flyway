...
create and compile java source named "org/flywaydb/core/internal/dbsupport/oracle/sql/java/JavaSource" as
package org.flywaydb.core.internal.dbsupport.oracle.sql.java;
...
create java resource named "org/flywaydb/core/internal/dbsupport/oracle/sql/java/JavaResource.txt" using clob
select
'Hello Flyway!'
from dual;
/